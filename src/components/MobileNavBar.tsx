...
const MobileNavBar = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-border py-1 px-4 md:hidden z-50 shadow-lg">
      <div className="flex justify-around items-center">
        <Link to="/" className="flex flex-col items-center p-2">
          ...
          <span className={`text-xs mt-1 ${isActive('/') ? 'font-medium text-primary' : 'text-muted-foreground'}`}></span>
        </Link>
        <Link to="/property/nearby" className="flex flex-col items-center p-2">
          ...
          <span className={`text-xs mt-1 ${isActive('/property/nearby') ? 'font-medium text-primary' : 'text-muted-foreground'}`}></span>
        </Link>
        <Link to="/buyer/dashboard" className="flex flex-col items-center p-2">
          ...
          <span className={`text-xs mt-1 ${isActive('/buyer/dashboard') ? 'font-medium text-primary' : 'text-muted-foreground'}`}></span>
        </Link>
        <Link to="/profile" className="flex flex-col items-center p-2">
          ...
          <span className={`text-xs mt-1 ${isActive('/profile') ? 'font-medium text-primary' : 'text-muted-foreground'}`}></span>
        </Link>
      </div>
    </div>
  );
